...
const fieldsParamsDetails = {
  fields: `${fieldsParams.fields},advice,description,description_teaser,ambiance,labels,source,information_desks,web_links,courses,pdf,ratings,ratings_description`,
  format: 'geojson',
};
