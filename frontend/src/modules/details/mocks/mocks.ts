...
export const rawDetailsProperties: RawDetailsProperties = {
  ...
  pdf: 'https://geotrekdemo.ecrins-parcnational.fr/api/fr/treks/2/col-de-font-froide_booklet.pdf',
  practice: 4,
  public_transport:
...
export const rawPois = {
  ...
  results: [
    {
      id: 442,
      create_datetime: '2019-05-22T06:29:36.255008Z',
      description:
      ...
      published: true,
      type: 3,
      update_datetime: '2019-05-22T06:29:36.360713Z',
      url: 'https://geotrekdemo.ecrins-parcnational.fr/api/v2/poi/442/',
    },
    {
      id: 66,
      create_datetime: '2019-03-27T16:54:28.780271Z',
      ...
      url: 'https://geotrekdemo.ecrins-parcnational.fr/api/v2/poi/66/',
    },
  ],
};

export const rawPoiTypeResponse = {
  count: 15,
  next: null,
  previous: null,
  results: [
