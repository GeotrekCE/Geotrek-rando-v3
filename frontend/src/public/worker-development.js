...
const cacheName = 'trek-pages'; // fetch the resource from the network
...
self.addEventListener('fetch', event => {
  if (event.request.url.includes('/trek/') || event.request.url.includes('/service/') || event.request.url.includes('/outdoor-site/') || event.request.url.includes('/outdoor-course/')) {
